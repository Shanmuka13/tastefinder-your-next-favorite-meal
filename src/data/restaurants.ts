...
export const restaurants: Restaurant[] = [
  {
    ...
    menuItems: [
      { name: "Truffle Pasta", price: "$28", description: "Fresh tagliatelle with black truffle cream sauce" },
      { name: "Margherita Pizza", price: "$18", description: "San Marzano tomatoes, fresh mozzarella, basil" },
      { name: "Osso Buco", price: "$36", description: "Slow-braised veal shanks with gremolata" },
  ...
  },
  {
    ...
    menuItems: [
      { name: "Omakase (12 pieces)", price: "$85", description: "Chef's selection of premium nigiri" },
      { name: "Dragon Roll", price: "$22", description: "Eel, avocado, cucumber with spicy mayo" },
      { name: "Sashimi Platter", price: "$45", description: "18 pieces of assorted fresh sashimi" },
      { name: "Mochi Ice Cream", price: "$8", description: "Green tea, mango, and strawberry" },
    ],
    reviews: [
  ...
  },
  {
    ...
    menuItems: [
      { name: "Butter Chicken", price: "$18", description: "Tender chicken in rich tomato cream sauce" },
      { name: "Lamb Biryani", price: "$22", description: "Aromatic basmati rice with slow-cooked lamb" },
      { name: "Paneer Tikka", price: "$15", description: "Marinated cottage cheese grilled in tandoor" },
  ...
  },
  {
    ...
    menuItems: [
      { name: "Classic Smash Burger", price: "$12", description: "Double patty, American cheese, special sauce" },
      { name: "Truffle Mushroom Burger", price: "$16", description: "Swiss cheese, sautéed mushrooms, truffle aioli" },
      { name: "Loaded Fries", price: "$9", description: "Bacon, cheese, jalapeños, ranch" },
      { name: "Milkshake", price: "$7", description: "Vanilla, chocolate, or strawberry" },
    ],
    reviews: [
  ...
  },
  {
    ...
    menuItems: [
      { name: "Buddha Bowl", price: "$16", description: "Quinoa, roasted vegetables, tahini dressing" },
      { name: "Mushroom Risotto", price: "$20", description: "Creamy arborio rice with wild mushrooms" },
      { name: "Acai Bowl", price: "$14", description: "Fresh acai, granola, seasonal fruits" },
      { name: "Raw Chocolate Cake", price: "$10", description: "Rich cacao, cashew cream, date crust" },
    ],
    reviews: [
  ...
  },
  {
    ...
    menuItems: [
      { name: "Foie Gras", price: "$32", description: "Seared with fig compote and brioche" },
      { name: "Beef Bourguignon", price: "$42", description: "Slow-braised beef in red wine sauce" },
      { name: "Crème Brûlée", price: "$14", description: "Classic vanilla bean custard" },
      { name: "Cheese Board", price: "$24", description: "Selection of French artisan cheeses" },
    ],
    reviews: [
